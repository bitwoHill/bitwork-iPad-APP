var products_CONTAINER = "#products-item-container", products_EMPTY_CONTAINER = "#products-empty-container", products_ITEM_TEMPLATE = "#products-item-template", ProduktNames = [];
...
var ProductsUI = {
	...
	displayproducts : function() {
		var $container = $(products_CONTAINER), $template = $(products_ITEM_TEMPLATE);
...
console.log(formattedPrice);
									...
									$('.products-item-piecenumber', $newItem).html(data.pieceNumber).attr("href", "MPLStammdaten.html?Produktgruppe=" + ProduktgruppePar + "&Produktfamilie=" + ProduktfamiliePar + "&Produktplattform=" + ProduktplatformPar + "&Produkt=" + data.productFK + "&ProduktName=" + ProduktName + "&EquipmentProdukt=" + data.equipmentId);

									$('.products-item-volume', $newItem).html(data.volume).attr("href", "MPLStammdaten.html?Produktgruppe=" + ProduktgruppePar + "&Produktfamilie=" + ProduktfamiliePar + "&Produktplattform=" + ProduktplatformPar + "&Produkt=" + data.productFK + "&ProduktName=" + ProduktName + "&EquipmentProdukt=" + data.equipmentId);

									$('.products-item-price', $newItem).html(formattedPrice).attr("href", "MPLStammdaten.html?Produktgruppe=" + ProduktgruppePar + "&Produktfamilie=" + ProduktfamiliePar + "&Produktplattform=" + ProduktplatformPar + "&Produkt=" + data.productFK + "&ProduktName=" + ProduktName + "&EquipmentProdukt=" + data.equipmentId);
...
console.log(formattedPrice);
									...
									$('.products-item-price', $newItem).html(formattedPrice).attr("href", "MPLStammdaten.html?Produktgruppe=" + ProduktgruppePar + "&Produktfamilie=" + ProduktfamiliePar + "&Produktplattform=" + ProduktplatformPar + "&Produkt=" + data.productFK  + "&ProduktName=" + ProduktName + "&SonstigesProdukt=" + data.otherProductId);
									$('.products-item-volume', $newItem).html(formattedPrice).attr("href", "MPLStammdaten.html?Produktgruppe=" + ProduktgruppePar + "&Produktfamilie=" + ProduktfamiliePar + "&Produktplattform=" + ProduktplatformPar + "&Produkt=" + data.productFK  + "&ProduktName=" + ProduktName + "&SonstigesProdukt=" + data.otherProductId);
